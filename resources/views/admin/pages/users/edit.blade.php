...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4 fw-bold"><span class="text-muted fw-light">Users /</span>
                Edit User
            </h4>
            {{-- start row --}}
            <div class="mb-4 row">
                ...
                <div class="mb-4 col-md mb-md-0">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <form class="browser-default-validation" method="post" action="{{route('User.update', $data->id)}}" enctype="multipart/form-data">
                              {{csrf_field()}}
