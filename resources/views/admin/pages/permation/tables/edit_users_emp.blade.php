<div class="col-4">
    <div class="mb-3">
        ...
        <select name="col[]" class="form-select col_type" required data-id="{{$custom_update->page_name}}" >
            ...
            <option value="name" data-type="string" data-select2-id="name" @if($custom_update->col == 'name')selected @endif >Name</option>
            ...
            <option value="phone" data-type="string" data-select2-id="phone" @if($custom_update->col == 'phone')selected @endif >Phone</option>
            <option value="email" data-type="string" data-select2-id="email" @if($custom_update->col == 'email')selected @endif >E-Mail</option>
